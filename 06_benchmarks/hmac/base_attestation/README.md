...
This program is based on [VRASED](https://github.com/sprout-uci/vrased) (GPL 3.0), which uses the [HACL*](https://github.com/hacl-star/hacl-star) (Apache 2.0) cryptographic library.
